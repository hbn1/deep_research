...
class MemoryManager:
    """DEPRECATED: Use MemoryOrchestrator (v2) with UnifiedMemoryStore + ShortTermService.

    This class is kept for backward compatibility during migration.
    It will be removed once v2 is confirmed stable.
    """
    ...
    def _deserialize_message(payload):
        ...
        if hasattr(payload, "content") and hasattr(payload, "type"):
            return payload
        # Dict-based payload - deserialize
