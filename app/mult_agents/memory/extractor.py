...
class MemoryExtractor:
    ...
    async def summarize(self, conversation_text: str, max_length: int = 300) -> str:
        """Generate a concise summary of a conversation.

        Args:
            conversation_text: Raw conversation text to summarize.
            max_length: Target max summary length in characters.
        ...
        if self._llm:
            try:
                ...
                _logger.warning("LLM summary failed: %s", exc)
